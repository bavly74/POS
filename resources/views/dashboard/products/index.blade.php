                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                @if(auth()->user()->hasPermission('products_create'))
                                    <a href="{{route('dashboard.products.create')}}" class="btn btn-warning"><i class="fa fa-plus"></i> @lang('site.add')</a>
                                    @else
                        ...
                        <table class="table table-hover">
                            ...
                            @foreach ($products as $index=>$product)
                                <tr>
                                    ...
                                    <td> <img src="{{ $product->image_path }}" style="width: 200px" class="thumbnail"> </td>
                                    ...
                                    <td>
                                            ...
                                            <form action="{{ route('dashboard.products.delete' , $product->id ) }}" method="post" style="display: inline-block">
                                                {{ csrf_field() }}
